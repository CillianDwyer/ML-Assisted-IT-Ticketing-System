...
function ModelDetails() {
  return (
    <div className="ticket-card dashboard-card model-details-page">
      <PageHeader
        title="ML Model Details"
        subtitle="Admin-only reference for how ticket issue type classification was tested and why the current model was selected."
        action={
          <Link to="/settings" className="page-header-action">
            Back to Settings
          </Link>
        }
      />
      ...
      <section className="model-details-hero">
        <div className="model-details-hero-copy">
          <div className="settings-hero-eyebrow">Prediction pipeline</div>
          <h2 className="model-details-title">TF-IDF features + LinearSVC power the issue-type prediction.</h2>
